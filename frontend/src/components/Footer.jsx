...
const Footer = () => {
  return (
    <footer className="flex flex-col  items-center justify-around w-full py-16 text-sm  bg-gray-800">
      <div className="flex items-center text-gray-200 gap-8">
        <a
          href="#"
      ...
      <div className="flex items-center gap-4 mt-8 text-gray-200">
        <a
          href="#"
      ...
      <p className="mt-8 text-center text-gray-200">
        Copyright © 2025 <a href="https://prebuiltui.com">Bhushan Digitronix</a>
